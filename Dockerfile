...
RUN echo '[supervisord]' > /etc/supervisord.conf && \
    ...
    echo 'command=sh -c "npx prisma migrate deploy && node prisma/seed.js && node src/scripts/create-admin.js && node src/scripts/create-demo-customer.js && node src/server.js"' >> /etc/supervisord.conf && \
